...
/**
 * \file    test/phpunit/CliEnjoyHolidaysFunctionalTest.php
...
/**
 * Class CliEnjoyHolidaysFunctionalTest
 *
 ...
 *
 * @package Testclienjoyholidays
 */
class CliEnjoyHolidaysFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modCliEnjoyHolidays')->click();
		} else {
			// Disable the module
			$this->byHref('modCliEnjoyHolidays')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/clienjoyholidays/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('clienjoyholidays/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/clienjoyholidays/admin/about.php');
		$this->authenticate();
		return $this->assertContains('clienjoyholidays/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('clienjoyholidayswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modCliEnjoyHolidays_CliEnjoyHolidaysTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modCliEnjoyHolidays_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
