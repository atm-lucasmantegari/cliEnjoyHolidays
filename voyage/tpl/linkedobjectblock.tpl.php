...
print "<!-- BEGIN PHP TEMPLATE clienjoyholidays/core/tpl/linkedobjectblock_myobject.tpl.php  -->\n";
...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	<tr class="<?php echo $trclass; ?>">
		...
		<td></td>
		<td class="center"><?php
			if ($objectlink->datedepart){
				echo dol_print_date($objectlink->datedepart,  'day');
			}else{
				echo "Date non renseignée";
			}
			?></td>
		<td class="right"><?php echo $objectlink->amount. " €"; ?></td>
